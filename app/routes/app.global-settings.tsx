...
export const action = async ({ request }: ActionFunctionArgs) => {
  ...
  if (request.method === "POST") {
    ...
    if (source === "ButtonDesign") {
      ...
      return json({
        message: "App status saved successfully",
        data: responseData,
      });
    }
  }
...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  try {
    const [buttonSettings, tooltipSettings, appStatusSettings] =
      await Promise.all([
...
const tabIcons: Record<string, JSX.Element> = {
  ...
  animationType: (
    <svg width="15" height="15" fill="none" viewBox="0 0 24 24">
      <path
        d="M5 12a7 7 0 1014 0"
        stroke="currentColor"
        strokeWidth="1.75"
        strokeLinecap="round"
      />
      <path
        d="M12 5V2M12 5l-2-2M12 5l2-2"
        stroke="currentColor"
        strokeWidth="1.75"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const GlobalSettings = () => {
  ...
  const tabDescriptions: Record<string, string> = {
    ...
    buttonDesign:
      "Customize the Add to Cart button appearance and hotspot style",
    tooltipDesign:
      "Style the product tooltip that appears when hovering a hotspot",
        ...
        >
          <div>
            ...
            <p style={{ fontSize: 13, color: "#64748B", margin: 0 }}>
              Customize the look and feel of your shoppable catalog experience
            </p>
          </div>
          <Link
            to="/app/pdf-convert"
          ...
          <div>
            ...
            >
              ...
              <div>
                ...
                >
                  {buttonsName.find(({ link }) => link === activeButton)
                    ?.name || "Settings"}
                </h2>
                <p style={{ fontSize: 13, color: "#64748B", margin: 0 }}>
                  {tabDescriptions[activeButton] ||
